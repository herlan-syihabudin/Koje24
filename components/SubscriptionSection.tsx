    ...
    >
      ...
      <div className="text-center mb-16 relative z-10">
        ...
        <p className="font-inter text-gray-600 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
          Pilih paket sesuai kebutuhan <b>detoks & energi harianmu</b> — praktis, hemat, dan tetap alami.  
          <br />Nikmati <span className="text-[#0FA3A8] font-semibold">#SehatBarengKOJE</span> setiap hari 🍃
        </p>
      </div>
