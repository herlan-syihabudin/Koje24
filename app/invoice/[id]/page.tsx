...
        
        {/* === 1. HEADER PERUSAHAAN (GAP DIKECILKAN: pb-4 mb-4) === */}
        <div className="flex items-start justify-between border-b border-slate-200 **pb-4 mb-4** print:mb-4 print:pb-3">
          <div>
...
        </div>
        
        {/* === 2. INFORMASI KLIEN & INVOICE DETAIL (GAP DIKECILKAN: mb-6) === */}
        <div className="grid grid-cols-3 gap-4 text-xs md:text-sm **mb-6** print:mb-4 print:text-[11px]">
            {/* KEPADA */}
...
        {/* === 4. RINGKASAN & TOTAL AKHIR (GAP DIKECILKAN: mt-6) === */}
        <div className="**mt-6** flex flex-col items-end text-sm w-full print:mt-4">
            {/* Subtotal */}
...
        {/* === 5. Rincian Pembayaran & Kontak CS (GAP DIKECILKAN: mt-8 pt-4) === */}
        <div className="**mt-8** grid grid-cols-2 gap-4 text-sm border-t border-slate-200 **pt-4** print:mt-4 print:pt-4 print:text-[11px]">
          <div>
