...
export const products: Product[] = [
  ...
  },
  {
    ...
    color: "#E6F89A",
    desc: "Lemon • Serai — rasa segar menenangkan untuk mood lebih stabil dan tubuh ringan.",
  ...
  },
  {
    ...
    color: "#FFE65A",
    desc: "Nanas • Lemon — vitamin C tinggi untuk bantu perkuat imun secara alami.",
