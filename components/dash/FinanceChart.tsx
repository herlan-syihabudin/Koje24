...
type ChartItem = {
  name: string;
  value: number;
  count?: number; // ✅ optional (karena API chart kamu cuma name + value)
};
        ...
        <div className="h-44">
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              ...
              <Tooltip
                formatter={(v: any) => `Rp ${Number(v || 0).toLocaleString("id-ID")}`}
              />
            </PieChart>
          </ResponsiveContainer>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-between text-xs text-gray-500 mt-1">
                  ...
                  <span>Rp {Number(item.value || 0).toLocaleString("id-ID")}</span>
                </div>
              </div>
            );
          })}
